  ...
  return (
    <div className='mt-5'>
      {contacts.map((contact) => (
        <div key={contact._id} className={`pl-10 py-2 transition-all duration-300 cursor-pointer ${selectedChatData && selectedChatData._id === contact._id? "bg-[#8417ff]} hover:bg-[#8417ff]" : "hover:bg-[#ff11ff]/50"}`} onClick={() => handleClick(contact)}>
