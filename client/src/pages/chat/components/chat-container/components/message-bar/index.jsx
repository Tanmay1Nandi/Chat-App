...
export default function MessageBar() {
  ...
  return (
    <div className='h-[15vh] sm:h-[9vh] bg-[#1c1d25] flex justify-center items-center px-8 mb-6 gap-3 sm:gap-5'>
      <div className="flex-1 flex bg-[#2a2d33] rounded-md gap-1 sm:gap-5 pr-5 items-center w-[80vw] sm:w-full">
        <input type='text' className='flex-1 p-3.5 sm:p-5 bg-transparent rounded-md focus:border-none focus:outline-none' placeholder='Enter Your Message' value={message} onKeyDown={handleKeyDown} onChange={(e) => setMessage(e.target.value)}/>
